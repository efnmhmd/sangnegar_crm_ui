...
export default function AuthLayout() {
	...
	return (
		...
		>
			<div className="relative mx-auto h-screen w-screen overflow-hidden rounded-3xl border-4 border-primary bg-black/50 bg-contain bg-center bg-no-repeat py-10 md:h-[80vh] md:w-[55vw]">
				<div
					className={twMerge(
				...
				>
					<div className="z-10 h-full w-2/5 overflow-auto rounded-3xl border-4 border-primary bg-black/70 px-4 py-8">
				...
				<div className="flex h-full items-stretch justify-between gap-20 p-8">
					...
					>
						...
						<div className="">
							...
							<h5 className="text-xl">لورم ایپسوم متن ساختگی</h5>
						</div>

						<div className="absolute flex items-center justify-between w-1/4 gap-3 bottom-2 right-4">
							<div className="p-2 px-4 py-2 duration-200 cursor-pointer rounded-s-lg hover:bg-primary">
								<Icon
									icon="bi:arrow-right"
									className="size-8"
								/>
							</div>
							<div className="px-4 py-2 duration-200 cursor-pointer rounded-e-lg hover:bg-primary">
								<Icon icon="bi:arrow-left" className="size-8" />
							</div>
						</div>
					</div> */}
				</div>
